...
int gpio_set_value(unsigned int gpio, unsigned int value);    // value can be 0 or 1 
int gpio_get_value(unsigned int gpio, unsigned int *value);   // *value will be 0 or 1 
